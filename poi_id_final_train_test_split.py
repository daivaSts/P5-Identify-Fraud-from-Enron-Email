...
# removing  data points not relevant to the analysis
...
# removind data points with all 0 values
...
features_train,features_test,labels_train, labels_test = cross_validation.train_test_split( features, labels, test_size=0.35, random_state=42 )
...
if False:
	...
	print "AdaBoostClassifier recall_score: {}".format( round( recall_sc, 3) )
	print "AdaBoostClassifier precision_score: {}".format( round( precision_sc, 3) )
...
if False:
	...
	print "RandomForestClassifier recall_score: {}".format( round( recall_sc, 3) )
	print "RandomForestClassifier precision_score: {}".format( round( precision_sc, 3) )
...
if False:
	...
	print "SVC accuracy: {}\n".format( round( acc, 3 ) )
	print "SVC recall_score: {}".format( round( recall_sc, 3) )	
	print "SVC precision_score: {}".format( round( precision_sc, 3) )
	print "SVC f1_score: {}\n".format( round( f1_sc, 3))
###############################################################################
